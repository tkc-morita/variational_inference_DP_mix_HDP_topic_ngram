...
if __name__ == '__main__':
	...
	df_ngram.to_csv(os.path.join(result_dir, 'worst-%i-representative_%igrams_in-sublex-%i_freq-at-least-%s.csv' % (list_length, n, sublex_id, str(min_frequency))), index=False, encoding='utf-8')
	# df_ngram.to_csv(os.path.join(result_dir, 'worst-%i-representative_%igrams_in-sublex-%i.csv' % (list_length, n, sublex_id)), index=False, encoding='utf-8')
