...
if __name__ == '__main__':
	...
	vowels = ['ä','äː']
	df_ngram = df_ngram[df_ngram.context.isin(ps) & df_ngram.value.isin(vowels)]
	...
	df_ngram.to_csv(os.path.join(result_dir, 'pbdV_freq-at-least-%s.csv' % (str(min_frequency))), index=False, encoding='utf-8')
