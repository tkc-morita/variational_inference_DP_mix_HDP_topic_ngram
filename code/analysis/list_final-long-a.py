...
if __name__ == '__main__':
	...
	longa = ['äː']
	end_symbol = ['END']
	df_ngram = df_ngram[(df_ngram.context.isin(longa)) & (df_ngram.value.isin(end_symbol))]
	...
	df_ngram.to_csv(os.path.join(result_dir, 'word-final-long-a_freq-at-least-%s.csv' % (str(min_frequency))), index=False, encoding='utf-8')
