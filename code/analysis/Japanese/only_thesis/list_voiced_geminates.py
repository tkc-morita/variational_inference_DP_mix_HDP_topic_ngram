...
if __name__ == '__main__':
	...
	voiced_geminates = ['bːː','ʣːː','ʥːː','gːː','dːː',]
	df_ngram = df_ngram[df_ngram.value.isin(voiced_geminates)]
	...
	df_ngram.to_csv(os.path.join(result_dir, 'voiced-geminates_freq-at-least-%s.csv' % (str(min_frequency))), index=False, encoding='utf-8')
