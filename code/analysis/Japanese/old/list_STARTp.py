...
if __name__ == '__main__':
	...
	df_ngram = df_ngram[(df_ngram.context=='START') & (df_ngram.value=='p')]
	...
	df_ngram.to_csv(os.path.join(result_dir, 'init-p_freq-at-least-%s.csv' % (str(min_frequency))), index=False, encoding='utf-8')
