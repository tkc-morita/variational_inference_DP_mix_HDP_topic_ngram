...
if __name__ == '__main__':
	...
	df_ngram = df_ngram[(df_ngram.context.isin(e)) & (df_ngram.value.isin(end))]
	...
	df_ngram.to_csv(os.path.join(result_dir, 'final-e_freq-at-least-%s.csv' % (str(min_frequency))), index=False, encoding='utf-8')
