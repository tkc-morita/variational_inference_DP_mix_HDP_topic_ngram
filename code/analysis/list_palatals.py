...
if __name__ == '__main__':
	...
	phi = ['r','ç']
	vowels = ['j']
	df_ngram = df_ngram[(df_ngram.context.isin(phi)) & (df_ngram.value.isin(vowels))]
	...
	df_ngram.to_csv(os.path.join(result_dir, 'ry-and-hy_freq-at-least-%s.csv' % (str(min_frequency))), index=False, encoding='utf-8')
