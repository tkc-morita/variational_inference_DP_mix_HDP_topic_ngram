...
if __name__ == '__main__':
	...
	long_as = ['äː', 'ä']
	df_ngram = df_ngram[df_ngram.value.isin(long_as)]
	...
	df_ngram.to_csv(os.path.join(result_dir, 'long-a_freq-at-least-%s.csv' % (str(min_frequency))), index=False, encoding='utf-8')
