...
import variational_inference_DP_topic_ngram_mix_indep_with_rendaku as vin
import numpy as np
...
if __name__=='__main__':
	...
	parser.add_argument("-d", "--data", type=str, help="Path to data", default='../data/BCCWJ_frequencylist_suw_ver1_0_core-nouns_4th-ed_with-rendaku-rate.tsv')
	...
	rendaku_data = df.rendaku_rate_kojien
